...
IRANIAN_CURRICULUM = [
    ...
    # Additional courses
    ('AD-H10', 'علوم و فنون ادبی ۱', 'language', ['10']),
    ('ENW-10', 'کتاب کار زبان انگلیسی ۱', 'language', ['10']),
    ('ENW-11', 'کتاب کار زبان انگلیسی ۲', 'language', ['11']),
    ('ENW-12', 'کتاب کار زبان انگلیسی ۳', 'language', ['12']),
    ('HT-11', 'تاریخ معاصر ایران', 'general', ['11']),
    ('GS-11', 'زمین‌شناسی', 'science', ['11']),
    ('PS-H11', 'روان‌شناسی', 'general', ['11']),
]
